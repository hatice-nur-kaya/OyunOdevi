...
public class ACompany implements GamerDao {
	...
	public void add(Gamers gamers) {
		System.out.println("A þirketi tarafýndan  eklendi " + gamers.getFirstName() );
		
	}

	@Override
	public void delete(Gamers gamers) {
		System.out.println("A þirketi tarafýndan  silindi "+ gamers.getFirstName()  );
		
	}

	@Override
	public void update(Gamers gamers) {
		System.out.println("A þirketi tarafýndan  güncellendi "+ gamers.getFirstName()  );
